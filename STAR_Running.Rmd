...
Still did not work. Using R to create gtf file now
```
library(rtracklayer)
gff <- import.gff("Brassica_napus.annotation_v5.gff3")
gff
gff$gene_id <- ifelse(is.na(gff$ID),gff$Parent,gff$ID)
export(gff,"Brassica_napus.annotation_v5.gtf",format="gtf")
```
