...
awk '$3 !="\*"' aln.sam > mapped

## SAM of unmapped reads
awk '$3 =="\*"' aln.sam > unmapped
```
...
grep "^SN840" mapped | awk '{print $1}' | sort | uniq | wc -l

## number of unmapped reads
wc -l unmapped

## number of uniquely mapped reads
grep "^SN840" mapped | awk '{print $1}' | sort | uniq -c | grep '^ *1 ' | wc -l

## number of reads multimapped
grep "^SN840" mapped | awk '{print $1}' | sort | uniq -cd | wc -l
```
