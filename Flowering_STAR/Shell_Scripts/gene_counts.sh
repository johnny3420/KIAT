#!/bin/bash
cd /Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/johndavis/KIAT/Flowering_STAR/Alignments/All_Alignments
...
paste flowering.star.50bp.read.count.tsv  100bp.reads> flowering.star.read.count.tsv
